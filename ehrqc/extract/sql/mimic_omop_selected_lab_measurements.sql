...
(
    ...
    AVG(carbondioxide_blood) AS carbondioxide_blood,
    AVG(albumin) AS albumin,
    AVG(glucose_urine) AS glucose_urine,
    AVG(band_form_neutrophils) AS band_form_neutrophils,
    AVG(base_excess_in_blood) AS base_excess_in_blood,
    AVG(potassium_blood) AS potassium_blood,
    AVG(ph_blood) AS ph_blood,
    AVG(chloride_serum) AS chloride_serum,
    AVG(carbondioxide_serum) AS carbondioxide_serum,
    AVG(bilirubin) AS bilirubin,
    AVG(leukocytes_blood_auto) AS leukocytes_blood_auto,
    AVG(creatinine) AS creatinine,
    AVG(inr) AS inr,
    AVG(sodium_serum) AS sodium_serum,
    AVG(sodium_blood) AS sodium_blood,
    AVG(hemoglobin) AS hemoglobin,
    AVG(ph_bodyfluid) AS ph_bodyfluid,
    AVG(platelet_count) AS platelet_count,
    AVG(urea_nitrogen) AS urea_nitrogen,
    AVG(glucose_serum) AS glucose_serum,
    AVG(chloride_blood) AS chloride_blood,
    AVG(oxygen) AS oxygen,
    AVG(bicarbonate) AS bicarbonate,
    AVG(potassium_serum) AS potassium_serum,
    AVG(anion_gap) AS anion_gap,
    AVG(leukocytes_blood_manual) AS leukocytes_blood_manual,
